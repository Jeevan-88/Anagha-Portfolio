...
export default function Education() {
  ...
  return (
    <section className="relative w-full py-16 md:py-20 px-6 md:px-12 bg-canvas-subtle/50 border-b border-ink/10">
      <div className="mx-auto max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 pb-4 border-b border-ink/10">
          ...
          <span className="text-[11px] font-mono text-ink/40 mt-1 md:mt-0">
            ...
            >
              <div className="space-y-1.5">
                <div className="flex items-center justify-between text-xs font-mono text-ink/50 mb-1">
                  ...
                  <span className="text-saffron font-medium">{edu.score}</span>
                </div>
